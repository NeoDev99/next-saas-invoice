...
import { PlusCircle, Save, SquarePen } from "lucide-react";
						...
						<div className='justify-between flex-col'>
							...
							<div className='flex space-x-3'>
								<div className='flex flex-col w-1/4'>
									<label htmlFor='itemName' className='text-sm'>Name</label>
									<Input
										type='text'
										name='itemName'
										placeholder='Name'
								...
								<div className='flex flex-col w-1/4'>
									<label htmlFor='itemCost' className='text-sm'>Cost</label>
									<input
										type='number'
										name='itemCost'
										placeholder='Cost'
